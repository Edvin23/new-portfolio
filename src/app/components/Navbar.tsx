...
const Navbar = () => {
  return (
    ...
    py- flex items-center text-center z-50 sm:max-xl '>
          ...
          <ul className='text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl mt-6 h-full md:flex md:flex-col gap-4 px-4 py-2 md:px-6 md:py-4
           lg:px-8 lg:py-6 
      ...
      className="max-w-xl sm:w-[80%] md:w-4/5 lg:w-3/5 xl:w-1/2"
